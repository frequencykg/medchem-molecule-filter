...
def example_3_property_calculation():
    ...
    print(df_with_props[[
        "compound", "smiles", "molecular_weight", "logP", 
        "tpsa", "hbd", "hba", "rotatable_bonds", "aromatic_rings"
    ...
    print(df_selected[["compound", "molecular_weight", "logP", "hbd", "hba"]].to_string(index=False))
...
def example_4_property_filtering():
    ...
    df = pd.DataFrame({
        "compound": [
            "Ethanol", "Aspirin", "Caffeine", "Large Molecule", "Lipophilic"
        ],
        "smiles": [
            "CCO",                                      # Small, passes
...
def example_5_comprehensive_pipeline():
    ...
    print(df_props[[
        "id", "molecular_weight", "logP", "hbd", "hba"
    ...
    print("\nFinal Results:")
    print(df_final[[
        "id", "smiles", "molecular_weight", "logP", "hbd", "hba"
    ]].to_string(index=False))
...
def example_6_csv_workflow():
    ...
    print("\nFiltered data:")
    print(df_filtered[[
        "compound_id", "smiles", "molecular_weight", "logP"
    ]].to_string(index=False))
...
def example_7_merge_with_activity_data():
    ...
    # Filter compounds
    filters = [PAINSFilter(), ReactiveFilter()]
    compounds_filtered = apply_filters_to_dataframe(
        compounds, filters, detailed=True
    )
    ...
    print("\n\nMerged Data:")
    print(merged[[
        "compound_id", "smiles", "passes_all", "ic50_nm"
    ]])
